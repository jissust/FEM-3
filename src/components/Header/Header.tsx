...
function Header() {
  ...
  return (
    <nav>
      <div className="max-w-[1170px] mx-auto flex justify-between items-center bg-white dark:bg-[#1f2535] px-[10px] md:px-[15px] py-[6px] md:py-[6px] md:py-[11px] rounded-[10px] shadow-sm">
