  ...
  return (
    <nav>
      ...
      { themeDark ?  <LogoDark /> : <Logo /> }
        <button onClick={changeTheme} className="bg-gray-200 dark:bg-[#2f354b] p-[14px] rounded-xl hover:cursor-pointer border-2 border-transparent hover:border-2 hover:border-[#eef8fa] dark:hover:border-[#1f2535] hover:outline-2 hover:outline-[#f45c51] transition-colors duration-1000 ease-in-out">
